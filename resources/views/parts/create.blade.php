...
@section('title', __('messages.add_new_part'))
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-success text-white">
                    <h4 class="mb-0"><i class="bi bi-plus-circle"></i> {{ __('messages.add_new_part') }}</h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('parts.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            @error('image')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="form-text text-muted">Dozvoljeni formati: JPG, PNG, GIF (max 2MB)</small>
                        </div>
